...
--questo rca fa la somma per la metà meno significativa degli ingressi
...
-- questo somma la metà più significativa degli ingressi con cin=0
...
-- questo somma la metà più significativa degli ingressi con cin=1
...
--selettore per capire quale sommatore utilizzare per la metà più significativa
