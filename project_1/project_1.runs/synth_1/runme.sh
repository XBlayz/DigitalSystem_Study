...
HD_PWD='C:/Users/CostanzaFerrari/Desktop/progetto/DigitalSystem_Study/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BufferLine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BufferLine.tcl
