...
HD_PWD='C:/Users/CostanzaFerrari/Desktop/progetto/DigitalSystem_Study/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BufferLine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BufferLine.tcl -notrace
