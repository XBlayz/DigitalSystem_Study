...
È importante sottolineare che, l’estensione con lo zero a destra e l’estensione con segno a sinistra non richiedono risorse aggiuntile ma solo un collegamento rispettivamente verso GND e verso il MSB.
...
A questo punto si arriverà ad avere tre vettori da 15-bit ciascuno, rispettivamente uno di somma e due di riporti. I tre vettori andranno in ingresso al livello di somma finale composto da quindici Full Adder che darà come uscita i due vettori finali di somma e riporto da 16-bit. 
A livello grafico:
\begin{figure}[H]
	\centering
