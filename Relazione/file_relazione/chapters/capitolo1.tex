...
Il risultato sarà il pixel centrale filtrato con il Filtro Gaussiano o Gaussian Blur che ha come coefficienti:
\begin{table}[H]
\begin{tabular}{|c|c|c|}
\hline
1 & 2 & 1 \\ \hline
...
\begin{itemize}
	...
	\item uno per rielaborare le componenti numeriche e ricostruire l'immagine filtrata.
\end{itemize}