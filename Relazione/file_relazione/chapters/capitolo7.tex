...
Si proverà adesso a filtrare un’immagine 32x32 pixel utilizzando in un primo caso un filtro Gaussiano 3x3 con fattore di normalizzazione pari a sedici e, in un secondo caso, un filtro di Sobel orizzontale 3x3 con fattore di normalizzazione pari a quattro. 
...
\section{Il filtro di Sobel (orizzontale)}
Prendendo in considerazione il filtro di Sobel orizzontale, esso sarà composto dai seguenti coefficienti:
\begin{table}[H]
\begin{tabular}{|c|c|c|}
\hline
-1 & 0 & 1 \\ \hline
